...
let roboFriend = document.querySelector('.RoboFriend');
let hotstarClone = document.querySelector('.HotstarClone');
let faceDetection = document.querySelector('.FaceDetection');
roboFriend.addEventListener('mouseover',()=>playVideo(roboFriend));
roboFriend.addEventListener('mouseout',()=>pauseVideo(roboFriend));
hotstarClone.addEventListener('mouseover',()=>playVideo(hotstarClone));
hotstarClone.addEventListener('mouseout',()=>pauseVideo(hotstarClone));
faceDetection.addEventListener('mouseover',()=>playVideo(faceDetection));
faceDetection.addEventListener('mouseout',()=>pauseVideo(faceDetection));
